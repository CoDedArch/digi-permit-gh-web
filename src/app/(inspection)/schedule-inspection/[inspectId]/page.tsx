...
export default function InspectionDetailPage() {
  ...
  if (!inspection) {
    return (
      <p className="text-center text-red-600 container mx-auto px-6 bg-white min-h-screen">
    ...
    <div className="flex justify-center bg-gray-50 min-h-screen py-10">
      <div className="w-full max-w-3xl px-4 space-y-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md space-y-2">
          ...
          <p>
            <span className="font-medium text-gray-600">MMDA:</span> {mmda.name}
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md space-y-2">
          ...
          {inspection_officer ? (
            <p>
              ...
              {inspection_officer.first_name +
                " " +
                inspection_officer.last_name}
            </p>
          ) : (
