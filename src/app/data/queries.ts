...
export async function uploadFile(file: File): Promise<string> {
  ...
  const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}uploads/user-documents`, {
    method: "POST",
    body: formData,
    credentials: "include"
  });
...
export async function getPermitTypesWithRequirements(): Promise<PermitTypeWithRequirements[]> {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}permits/types`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
...
export async function getPermitTypes(): Promise<PermitType[]> {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}permits/permit-types`, {
      headers: {
        "Content-Type": "application/json",
      },
    });
...
export async function getApplicantTypes(): Promise<ApplicantType[]> {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}auth/applicant-types`, {
      headers: {
        'Content-Type': 'application/json',
      },
    })
...
export async function getZoningDistricts(): Promise<ZoningDistrict[]> {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}permits/zoning-districts`, {
      headers: {
        "Content-Type": "application/json",
      },
    });
...
export async function getZoningUses(zoningDistrictId: number): Promise<ZoningUse[]> {
  try {
    const response = await fetch(
...
export async function getDrainageTypes(): Promise<{ id: number; name: string; description?: string }[]> {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}permits/drainage-types`, {
      headers: {
        "Content-Type": "application/json",
      },
    });
...
export async function getSiteConditions(): Promise<{ id: number; name: string; description?: string }[]> {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}permits/site-conditions`, {
      headers: {
        "Content-Type": "application/json",
      },
    });
